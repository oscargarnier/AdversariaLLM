...
def test_ample_gcg_attack():
    ...
    cfg.ample_gcg.generation_config = generation_config
    cfg.ample_gcg.max_new_tokens = 256

    try:
        attack = AmpleGCGAttack(cfg.ample_gcg)
